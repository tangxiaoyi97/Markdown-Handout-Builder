...
async function makeShowcaseFixture() {
  ...
  const book = (await fs.readFile(bookPath, "utf8"))
    .replace("../../dist/showcase/obsidian-syntax-showcase-3.0-dialect.html", "dist/showcase.html")
    .replace("../../dist/showcase/obsidian-syntax-showcase-3.0-dialect.pdf", "dist/showcase.pdf");
